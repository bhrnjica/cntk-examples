...
#
train_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), r"../data/IRIS-TrainData.txt")
...
test_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), r"../data/IRIS-TestData.txt")
