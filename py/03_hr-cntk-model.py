# MSDN Magazine Article https://digital.1105media.com/MSDN/2018/MDN_1803/MO_1803Q1_701923067.html#p=62
# 
import os, sys
import numpy as np
import cntk as C
...
def create_reader(path, input_dim, output_dim, rnd_order, sweeps):
    ...
    y_strm = C.io.StreamDef(field='labels', shape=output_dim, is_sparse= False)
...
def main():
    ...
    train_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), r"../data/hr-cleveland-all-data.txt")
    ...
    rdr = create_reader(train_file, input_dim, output_dim, rnd_order= False, sweeps= C.io.INFINITELY_REPEAT)
    heart_input_map = {
        X: rdr.streams.x_src,
        Y: rdr.streams.y_src
    } 
